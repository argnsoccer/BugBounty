      <div class="modal fade" id="displayDetailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <textarea id="errorNameDisplay" readonly></textarea>
              </div>
              <div class="form-group">
                <label for="message-text" class="control-label">Description of Error:</label>
                <textarea id="errorDescriptionDisplay" readonly></textarea>
              </div>
              <div class="form-group">
                <label for="message-text" class="control-label">Path to Error:</label>
                <textarea id="errorPathDisplay" readonly></textarea>
              </div>
              <div class="form-group">
