...
CREATE TABLE IF NOT EXISTS `BugBounty`.`Account` (
  ...
  `accType` VARCHAR(10) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `BugBounty`.`BountyPool` (
  ...
  `imageLoc` VARCHAR(45) NULL COMMENT '',
  `lineDesc` VARCHAR(55) NULL COMMENT '',
  `fullDesc` VARCHAR(200) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `BugBounty`.`Report` (
  ...
  `hunterID` INT UNSIGNED NOT NULL COMMENT '',
  `ReportText` MEDIUMTEXT NULL COMMENT '',
  `payountAmt` INT NOT NULL COMMENT '',
  ...
  UNIQUE INDEX `hunterID_UNIQUE` (`hunterID` ASC)  COMMENT '',
