...
(1,'2015-11-29 21:44:19','1000','2015-01-01 00:00:00',3,'http://espn.go.com/mens-college-basketball/team/_/id/2567/smu-mustangs','_images/_bounties/_testMarshal1/bounty1.png','Video player on team pages breaks.','Please find the conditions that cause our video player to crash.', 'ESPN Video Player'),
(2,'2015-11-29 21:44:19','250','2015-01-01 00:00:00',4,'http://www.smu.edu','_images/_bounties/_testMarshal2/bounty2.png','The give now button has a strange bug.','The give now button tends to insert four zeros onto the amount given.', 'Give Now Button'),
(3,'2015-11-29 21:44:19','750','2015-09-08 00:00:00',5,'http://www.dallasnews.com/','_images/_bounties/_testMarshal3/bounty3.png','Our website displays the news from yesterday.','All of our news reports show up a day later than intended.', 'Live Updates'),
...
(7,'2015-11-29 21:44:19','2250','2015-01-01 00:00:00',3,'http://espn.go.com/nfl/','_images/_bounties/_testMarshal7/bounty7.png','The links to individual teams link to incorrect pages.','When a user clicks on a link for their favorite team, it takes them to the incorrect page.', 'Team Links'),
(8,'2015-11-29 21:44:19','400','2015-01-01 00:00:00',4,'http://www.smu.edu/BusinessFinance/CampusServices/ParkingAndIDcardServices','_images/_bounties/_testMarshal8/bounty8.png','Link sends users to wrong webpage.','Instead of sending users to get more information about the DART, it sends them to the donations page.', 'DART Pass Link'),
(9,'2015-11-29 21:44:19','3200','2015-01-01 00:00:00',5,'http://store.dallasnews.com/','_images/_bounties/_testMarshal9/bounty9.png','Prices of items are incorrect.','Some items in the store are given the wrong price value.', 'Store Page Prices');
...
INSERT INTO `Marshall` (marshallID,description,company, rssLink, rssCreated) VALUES
(3,'This is the official page for all bounties posted by ESPN','ESPN', 'http://ec2-52-88-178-244.us-west-2.compute.amazonaws.com/_rss/_profiles/_testMarshall1/rss_testMarshall1.xml', 1),
(4,'SMU is a university located in Dallas, Texas. New bounties posted frequently.','Southern Methodist University', 'http://ec2-52-88-178-244.us-west-2.compute.amazonaws.com/_rss/_profiles/_testMarshall1/rss_testMarshall1.xml', 1),
(5,'Official marshall page for the Dallas Morning News.','Dallas Morning News', NULL, 0);
